...
domino_artifact_dir = str(config.get_artifacts_dir())
domino_dataset_dir = str(config.get_dataset_dir())
domino_project_name = config.domino_project_name
...
def train_fraud(model_obj, model_name, transformed_df_filename, random_state=None):
    ...
    transformed_df_path = str(config.get_data_path(transformed_df_filename))
